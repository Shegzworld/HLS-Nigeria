...
from user.models import CustomUser as UserProfile,BasicInfo as Basic,LifestyleInfo as Lifestyle,PreferenceInfo as Preference, HealthConditionInfo as HealthCondition
