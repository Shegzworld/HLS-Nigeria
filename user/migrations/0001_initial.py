# Generated by Django 5.0.7 on 2025-01-21 08:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_profile', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='principal', to='user.userprofile')),
            ],
        ),
        migrations.CreateModel(
            name='Preference',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('principal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='benfeks', to='user.principal')),
                ('user_profile', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='benfek', to='user.userprofile')),
            ],
        ),
        migrations.CreateModel(
            name='Basic',
